//
//  InviteRecievedViewController.swift
...
class InviteRecievedViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if let metadataObject = metadataObjects.first {
            ...
            let alert = UIAlertController(title: "Test", message: stringValue, preferredStyle: .alert)
